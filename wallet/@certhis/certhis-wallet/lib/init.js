...
module.exports = function (Web3, CoinbaseWalletSDK, WalletConnectProvider) {
    ...
    const request = require("./request")("https://wallet-api.certhis.io/");
                ...
                inputN.addEventListener("input", function (event) {
                    ...
                    if (value.length === 1) {
                        var nextInput = document.querySelector(
                            `#certhis-wallet-certhis-code-${Number(event.target.id.split("-")[4]) + 1
                            }`
                        );
            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (balance >= amount_missing) {
                    ...
                    var InsertHTMLBOX =
                        ...
                        '<img src="https://utility-apps-assets.certhis.io/certhisWallet/wallet_logo/certhis_wallet.png" style="max-height: 45px;width:auto;margin-left: 20px;margin-top: 20px;">' +
                        ...
                        '<div id="first_step_add_fund_certhis" style="padding:25px"><div style="margin-top: 25px;padding-left: 20px;text-align: center;font-size: 17px;margin-bottom: 0px;">Insufficient Funds to Send Transaction</div>' +
                        '<div style="color: #707070;    font-size: 15px;    text-align: center;    margin-bottom: 50px;">You need additional credits in your wallet to pay the transaction.</div>' +
                        '<div style="    margin-top: 30px;margin-bottom: 30px;"><div style="display: inline-block;width: 35%;text-align: left;font-size: 17px;">Amount Missing</div> <div style="    font-weight: bolder;font-size: 17px;display: inline-block;width: 63%;text-align: right;">' +
                        String(amount_missing) +
                        " " +
                        rpcinfo.currency_array[chain_id] +
                        "</div></div>" +
                        '<div style="font-weight: bolder;font-size: 14px;margin-bottom: 20px;">Transfert funds to your Wallet</div>' +
                        '<input type="text" readonly style="background: #FFFFFF 0% 0% no-repeat padding-box;    border: none;    border-radius: 8px;    font-size: 13px;    height: 42px;    width: 100%;    text-align: center;    margin-bottom: 35px;    background: #F8F8F8;    border-radius: 8px;" value="' +
                        address +
                        '">';
                    ...
                    if (
                        ...
                        localStorage.getItem("BETA_ENABLE") != 1
                    ) {
                        InsertHTMLBOX =
                            InsertHTMLBOX +
                        ...
                        InsertHTMLBOX =
                            InsertHTMLBOX +
                            '<a href="https://pay.sendwyre.com/purchase?&destCurrency=' +
                            rpcinfo.currency_array[chain_id] +
                            "&dest=" +
                            address +
                            ' "style="text-decoration: underline;cursor:pointer;color:#000" target="_blank">Add funds via Credit Card</a>';
                    } else {
                        InsertHTMLBOX =
                            InsertHTMLBOX +
                    ...
                    InsertHTMLBOX =
                        ...
                        'src="https://widget.onramper.com?apiKey=pk_test_wE4B5qcOzGu0N2Rm0PGi8UDEOiYojKDS8cdL3c6Fkig0&supportSell=false&color=000&filters=onlyCryptos&onlyGateways=Moonpay&darkMode=false&defaultCrypto=' +
                        rpcinfo.currency_array[chain_id] +
                        "&onlyCryptos=" +
                        rpcinfo.currency_array[chain_id] +
                        "&isAddressEditable=false&isAmountEditable=true&display=buy&defaultAmount=100&defaultFiat=USD&supportSwap=false&walletAddress=" +
                        address +
                        " &cryptoCurrencyCode=" +
                        rpcinfo.currency_array[chain_id] +
                        '" frameborder="no" allowtransparency="true" allowfullscreen="" style="    display: block;max-width: 97%;width:500px;margin: auto;height: 600px;max-height: 625px;margin-bottom: 10px;border:none;">' +
                        "</iframe></div>" +
                        "</div>";
        ...
        run: async function (
			...
			console.log('aaaaa');
                    ...
                    InsertHTMLBOX =
                        ...
                        '<div style="margin-bottom: 25px; margin-top: 25px; font-size: 24px; font-weight: bold; color: #000000;">Connect To Your Wallet</div>' +
                        '<div style="display: none; font-size:25px;text-align: center;font-size: 20px;margin-top: 30px;text-align: center;color: #505050;" >Don\'t have a wallet Yet ?</div>' +
                        '<div style="display: none; font-size: 14px; margin-bottom: 25px;color: #807979;font-weight: 300;    margin-top: 10px;">Use your email directly and start navigating<br>on Web3 instantly.</div>' +
                        '<div id="' +
                        id_insert +
                        '-ErrorMessageCerthisWallet" style="display:none;color:red;"></div>' +
                        '<div style="display: none; position: relative;width: fit-content;margin: auto;"><input type="email"  id="' +
                        id_insert +
                        ...
                        '<div style="margin-bottom: 25px; margin-top: 25px; font-size: 14px; color: #807979;"> ' +
                        // text_wallet_connect_with +
                        " </div>" +
                        '<button id="' +
                        id_insert +
                        '-certhis-metamask-button" style="color: #000000;cursor: pointer;display: block;margin: auto;padding: 10px;font-size: 15px;padding-right: 17px;padding-left: 17px;margin-bottom: 30px;margin-top:20px;border-radius: 31px;border: none;min-width: 300px;max-width: 100%;background: #F8F8F8;border-radius: 8px;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/wallet_logo/2.png" style="vertical-align: middle;height: 30px;margin-right: 10px;" ><div style="width: fit-content;display: none;vertical-align: initial;background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;border: 1px solid #000000;border-radius: 59px;padding: 4px;font-size: 15px;padding-right: 15px;padding-left: 15px;padding-top: 5px;line-height: 20px;">Connect</div></button>' +
                        '<button  id="' +
                        id_insert +
                        '-certhis-walletconnect-button" class="certhisWalletButton" style="color: #000000;cursor: pointer;display: block;margin: auto;padding: 10px;font-size: 15px;padding-right: 17px;padding-left: 17px;margin-bottom: 30px;margin-top:20px;border-radius: 31px;border: none;min-width: 300px;max-width: 100%;background: #F8F8F8;border-radius: 8px;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/wallet_logo/3.png"  style="vertical-align: middle;height: 30px;margin-right: 10px;" ><div style="width: fit-content;display: none;vertical-align: initial;background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;border: 1px solid #000000;border-radius: 59px;padding: 4px;font-size: 15px;padding-right: 15px;padding-left: 15px;padding-top: 5px;line-height: 20px;">Connect</div></button>' +
                        '<button id="' +
                        id_insert +
                        '-certhis-coinbase-button" style="color: #000000;cursor: pointer;display: none;margin: auto;padding: 10px;font-size: 15px;padding-right: 17px;padding-left: 17px;margin-bottom: 30px;margin-top:20px;border-radius: 31px;border: none;min-width: 300px;max-width: 100%;background: #F8F8F8;border-radius: 8px;"><img src="https://utility-apps-assets.certhis.io/certhisWallet/wallet_logo/1.png" style="vertical-align: middle;height: 30px;margin-right: 10px;" ><div style="width: fit-content;display: inline-block;vertical-align: initial;background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;border: 1px solid #000000;border-radius: 59px;padding: 4px;font-size: 15px;padding-right: 15px;padding-left: 15px;padding-top: 5px;line-height: 20px;">Connect</div></button>' +
                        '</div><div style="display:none; font-size: 12px;color: #807979;width: 250px;margin: auto;margin-top: 40px;margin-bottom:10px;">* By connecting your wallet, you accept our <a href="https://certhis.io/terms-of-use">Terms of Use</a> and acknowledge that you have read our <a href="https://certhis.io/privacy-policy">Privacy Policy</a>.</div></div>' +
                        ...
                        id_insert +
                        '-certhiswalletResend" style="text-decoration: underline;cursor: pointer;display:block;background: linear-gradient(90.17deg, #721AFF -34.45%, #04AB93 122.65%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;background-clip: text;text-fill-color: transparent;">Resend</span></div>' +
                        '<button id="' +
                        id_insert +
                        ...
                        input.addEventListener("input", function (event) {
                            ...
                            if (value.length === 1) {
                                const nextInput = document.querySelector(
                                    `#${id_insert}-certhis-code-${Number(event.target.id.split("-")[3]) +
                                    1
                                    }`
                                );
